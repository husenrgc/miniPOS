...
<div class="clearfix"></div>
  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><h6>Date Created :  <?php echo $product->timecreated ?> | Last Modified : <?php echo $product->timemodified ?> </h6></div>
            <div class="card-body">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" name="buyprice"  value="<?php echo set_value('buyprice',$product->buyprice); ?>">
  </div>
  <div class="form-group">
    <label >sellprice</label>
    <input type="text" class="form-control" name="sellprice"  value="<?php echo set_value('sellprice',$product->sellprice); ?>">
  </div>
  ...
  <!-- end form -->
        ...
        <a  href="<?php echo site_url('pages/product');?>"class="btn btn-secondary" >cancel</a>
